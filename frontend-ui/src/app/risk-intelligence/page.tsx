...
export default function Risk IntelligencePage() {
  return (
    <div className="flex h-screen w-screen bg-[#F8FAFC] overflow-hidden antialiased">
      ...
      <div className="flex-1 h-full flex flex-col p-6 space-y-6 overflow-y-auto">
        <div className="border-b border-slate-200 pb-4">
          <h1 className="text-lg font-black tracking-tight text-slate-900 uppercase font-mono">Risk Intelligence Command Desk</h1>
        ...
        <div className="panel-card bg-white p-6 flex-1 flex items-center justify-center border-dashed border-2 border-slate-200">
          <span className="font-mono text-xs text-slate-400 tracking-widest uppercase">Initializing Risk Intelligence telemetry matrices...</span>
        </div>
      </div>
    </div>
  );
